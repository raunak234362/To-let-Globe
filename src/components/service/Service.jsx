    ...
    <div className="px-7 mt-5 bg-black h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-5 text-black">
        {[
          ...
          { img: house, title: "House", bg: "bg-[#6CC1B6]", description: "Search for your dream home, available for rent or sale, tailored to your lifestyle and preferences" },
          { img: shop, title: "Shop", bg: "bg-[#CCB454]", description: "Explore a variety of retail spaces and shops available for lease, ideal for growing your business" },
          { img: office, title: "Office", bg: "bg-[#6CC1B6]", description: "Elevate your workspace and productivity with modern office spaces for rent, designed for success" },
          { img: warehouse, title: "Warehouse", bg: "bg-[#CCB454]", description: "Secure the perfect godown space for rent, offering ample storage and logistics solutions" }
        ].map((service, index) => (
          <div key={index} className="group relative bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex justify-center items-center p-5">
              <img src={service.img} className="h-20 w-auto" alt={service.title} />
            </div>
